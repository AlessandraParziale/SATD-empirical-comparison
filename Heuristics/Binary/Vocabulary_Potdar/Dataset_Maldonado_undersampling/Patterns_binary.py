...
if __name__ == "__main__":
    ...
    DATASET_CSV = "maldonado_undersampled.csv"
    VOCAB_CSV = "Vocabulary_Potdar.csv"
    ...
    tracker = OfflineEmissionsTracker(
        ...
        experiment_id="Binary_Vocabulary_Potdar_Dataset_Maldonado_undersampling",
        on_csv_write="append"
    )
    tracker.start()
