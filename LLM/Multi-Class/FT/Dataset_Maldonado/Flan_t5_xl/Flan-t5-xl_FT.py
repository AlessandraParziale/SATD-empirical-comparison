...
tracker = OfflineEmissionsTracker(
    ...
    experiment_id="Multi_Class_Flan-t5-xl_FT_Dataset_Maldonado_All", on_csv_write="append")
tracker.start()
...
metrics_path = "ft_satd_lora_results_V2/maldonado_flan-t5-xl_lora_metrics.txt"
...
cm_csv = "ft_satd_lora_results_V2/maldonado_flan-t5-xl_lora_confmat.csv"
pd.DataFrame(cm, index=label_list, columns=label_list).to_csv(cm_csv, index=True)
print("saved confmat csv:", cm_csv)


pred_csv = "ft_satd_lora_results_V2/maldonado_flan-t5-xl_lora_preds.csv"
pd.DataFrame({
...
lora_dir = "ft_satd_lora_results_V2/flan-t5-xl_lora_adapters"
