...
Task:
Choose and assign ONE label among: Code, M&T, Defect, Design, Documentation.
""".strip()
...
tracker = OfflineEmissionsTracker(
    ...
    experiment_id="Multi_Class_Llama3.1-8B_NO_FT_Dataset_OBrien_All", on_csv_write="append")
tracker.start()
...
with open(file_name + "_confmat.txt", "a", encoding="utf-8") as output_file:
