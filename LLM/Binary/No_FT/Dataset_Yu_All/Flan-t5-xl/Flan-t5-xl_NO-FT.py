...
tracker = OfflineEmissionsTracker(
    ...
    experiment_id="Binary_Flan-t5-xl_NO_FT_Dataset_Yu_All", on_csv_write="append")
tracker.start()
...
for i, row in df.iterrows():
    ...
    prompt = generate_prompt_without_adding_dynamic_examples(init_prompt_for_Dataset_Yu_MAT, row["prompt_context"])
...
with open(file_name + "_confmat.txt", "w") as output_file:
    output_file.write(f"Dataset: merged_Dataset_Yu.csv\n")
...
# Predictions CSV
orig_df = pd.read_csv("merged_Dataset_Yu.csv")
