...
df["label"] = df["satd"].astype(int)   # satd -> label (0/1)
...
tracker = OfflineEmissionsTracker(
    ...
    experiment_id="Binary_Flan-t5-xl_FT_Dataset_Maldonado_undersampling", on_csv_write="append")
tracker.start()
...
os.makedirs("results_all", exist_ok=True)
test_pred_path = "results_all/maldonado_test_with_predictions.csv"
