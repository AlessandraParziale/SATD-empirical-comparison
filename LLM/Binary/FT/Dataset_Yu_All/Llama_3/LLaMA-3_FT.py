...
tracker = OfflineEmissionsTracker(
    ...
    experiment_id="Binary_LLaMA-3_FT_Dataset_Yu_All", on_csv_write="append")
tracker.start()
...
same_format_path = "results_all_LLAMA/YuDataset_test_with_predictions.csv"
test_with_predictions.to_csv(same_format_path, index=False)

print(f"- Test+ predictions: {same_format_path}")
