...
tracker = OfflineEmissionsTracker(
    ...
    experiment_id="Binary_LLaMA-3_FT_Dataset_Yu_undersampling", on_csv_write="append")
tracker.start()
...
test_out["predicted_label"] = all_pred

test_out = test_out.rename(columns={
    "comment_text": "CommentsAssociated",
    "label": "CommentsAssociatedLabel"
})

os.makedirs("results_all_LLAMA", exist_ok=True)
test_pred_path = "results_all_LLAMA/merged_Dataset_Yu_test_with_predictions.csv"
test_out.to_csv(test_pred_path, index=False)

print(f"- Test set predictions: {test_pred_path}")
